...
SECRET_KEY = 'django-insecure-vt5px=#xnvw33of(p@py2ar#%)r08tf+cxal^lvlch*(o)&!2a'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Robledo - Admin",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Robledo's",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Robledo's",
    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "imgs/Enrique-Robledo.jpg",
    # "site_logo": "/sitac/kraken.webp",
    ...
    "copyright": "INTERFACE COMUNICAÇÃO E SISTEMAS",
    ...
    "order_with_respect_to": ["auth", "comum"],
